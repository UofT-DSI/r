...
| --- | --- | --- | --- |
| 1 | Monday 29 May <br> 6 PM - 8 PM EST | Hello World! And Work practices <br> (R basics; file types; errors) | [0- Introduction](./Lessons-PDF/00-introduction_deck.pdf) <br> [1- Hello World](./Lessons-PDF/01-hello-world_deck.pdf)|
